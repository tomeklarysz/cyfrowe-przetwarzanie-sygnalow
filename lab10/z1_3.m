...
if (au == 1) audio = 'mowa1.wav';
elseif (au == 2) audio = 'mowa2.wav';
else audio = 'mowa3.wav';
end
[x,fpr]=audioread(audio); % wczytaj sygnał mowy (cały)
figure; sgtitle(audio);
subplot(211);
plot(x); title('sygnał oryginalny'); % pokaż go
